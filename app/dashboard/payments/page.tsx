...
import { CompanyPaymentRequestsManager } from "@/components/payments/company-payment-requests-manager";
import { MyPaymentRequestsManager } from "@/components/payments/my-payment-requests-manager";
					...
					<div className="flex items-center gap-3 border-b bg-muted/20 px-5 py-4 sm:px-6">
						...
						<div>
							...
							<p className="text-xs text-muted-foreground">
								Requests, review workflows, and personal payout visibility in one
								place.
							</p>
						</div>
					</div>
